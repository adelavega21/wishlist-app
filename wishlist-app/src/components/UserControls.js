...
function UserControls(props){
  return (
    <div className="user-controls">
      ...
      {props.currentUser? <button onClick={props.removeUserState}><span role="img" aria-label="user-controls">{ props.currentUser.username.toUpperCase() } X</span></button>:null}
    </div>
  )
}
