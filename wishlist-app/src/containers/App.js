    ...
    return (
      <div className="App">
        ...
        <Switch>
          ...
          <Route path="/profile" render={(routerProps) => <ProfilePage addList={this.addNewWishList} currentUser={this.state.currentUser} setWishlist={this.setWishlist} removeUserState={this.removeUserState} wishlists={this.state.wishlists} {...routerProps}/>}/>
